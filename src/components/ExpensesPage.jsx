  ...
  return (
    <div className="p-4 pt-16 max-w-screen-2xl mx-auto space-y-6">
      <div className="bg-white p-6 rounded-xl shadow-sm">
        <h2 className="text-xl font-semibold text-gray-700 mb-4">Listado de gastos</h2>
        ...
        <div className="text-right mb-4 text-sm text-gray-600">
          Total visible: <span className="font-bold text-red-600">{formatCurrency(totalVisible)}</span>
        </div>
          ...
          <>
            <div className="space-y-4 md:hidden">
              {rows.map(row => {
                ...
                return (
                  <div key={expense.uuid} className="border rounded-md p-4 shadow-sm bg-gray-50">
                    <div className="text-sm text-gray-500">{formatDate(expense.datetime)}</div>
                    <div className="font-semibold text-gray-700">{expense.description}</div>
              ...
              <table {...getTableProps()} className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  {headerGroups.map((headerGroup, i) => (
                    <tr key={i} {...headerGroup.getHeaderGroupProps()}> {/* avoid warning */}
